...
\begin{center}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%
    \vspace{-0.5em}
    \begin{tcolorbox}[colback=white, colframe=black, width=0.95\linewidth, height=.32\linewidth, boxrule=1pt]
        \codelogoheader{Open-Source Nuclear Research Softwares}
        \sectioncontent{
            ...
            \end{minipage} 
            \begin{minipage}{.22\linewidth}
                \includegraphics[width =.7\linewidth]{img/pyne.png}
                \vspace{10pt}
            \end{minipage}
            \begin{minipage}{.22\linewidth}
