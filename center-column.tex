...
\begin{center}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%
    \vspace{-0.5em}
    \begin{tcolorbox}[colback=white, colframe=black, width=0.99\linewidth, height=.395\linewidth, boxrule=1pt]
        \codelogoheader{Open-Source Nuclear Research Software}
        \sectioncontent{
            ...
            \end{minipage}
            \begin{minipage}{.22\linewidth}
                \includegraphics[width=.9\linewidth]{img/ghastlylogo.png}
            \end{minipage}
            \begin{minipage}{.22\linewidth}
                \centering
                \includegraphics[width=1.25\linewidth]{img/cyclus.png}
                \newline\par\vspace{-0.7em}
                \centering
                \includegraphics[width=.85\linewidth]{img/rcana-circle-logo.png}
            \end{minipage}
        }
    \end{tcolorbox}
    ...
    \begin{minipage}{.22\linewidth}
        \centering
        \includegraphics[width=.85\linewidth]{img/qrcode.png}
        \figcaption{https://arfc.github.io/}
        % \vspace{-0.2em}
        % \href{https://arfc.github.io/}{\fontsizeauthor\underline{https://arfc.github.io/}}
    \end{minipage}
    %%%%%%%%%%%%%%%%%%%%%%%%%
    %%% Collaborator logos %%
    %%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%% Logos (UIUC, ARFC) %%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \includegraphics[height=0.23\textwidth]{img/UIUC_Logo.png}\hspace{5cm}
    \includegraphics[height=0.23\textwidth, trim={0 .5cm 0 .5cm}]{img/arfc_atom.png}
\end{center}
}{
}